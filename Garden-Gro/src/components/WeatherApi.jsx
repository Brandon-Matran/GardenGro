...
<div id="sticky-banner" tabIndex="-1" className="absolute start-0  flex justify-between w-full p-4 bg-gray-50 dark:bg-gray-700 dark:border-gray-600" style={{ fontFamily: "'Fugaz One', sans-serif", fontWeight: 400, fontStyle: 'normal'}}>
