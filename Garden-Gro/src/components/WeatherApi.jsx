...
<div id="sticky-banner" tabIndex="-1" className="fixed start-0 z-50 flex justify-between w-full p-4 border-b border-gray-200 bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
